...
export const projects = [
  {
    ...
    longDescription: "This comprehensive e-commerce platform revolutionizes online shopping with cutting-edge features including real-time inventory management, secure payment processing, and advanced analytics. Built with modern technologies, it provides a seamless shopping experience for customers while offering powerful management tools for administrators.",
    ...
    githubUrl: "https://github.com/techflow/ecommerce-platform",
    features: [
  ...
  },
  {
    ...
    longDescription: "This innovative healthcare mobile application transforms patient care by providing comprehensive tools for patient management, appointment scheduling, and telemedicine. Built with React Native and Firebase, it offers secure, real-time communication between patients and healthcare providers.",
    ...
    githubUrl: "https://github.com/techflow/healthcare-app",
    features: [
  ...
  },
  {
    ...
    longDescription: "This powerful SaaS dashboard revolutionizes project management with advanced team collaboration features, real-time updates, and comprehensive analytics. Built with Vue.js and Django, it provides an intuitive interface for managing complex projects and teams.",
    ...
    year: "2023",
    status: "Completed",
    liveUrl: "https://projectflow-demo.com",
    githubUrl: "https://github.com/techflow/saas-dashboard",
    features: [
  ...
  },
  {
    ...
    longDescription: "This cutting-edge AI-powered analytics platform transforms raw data into actionable business insights using advanced machine learning algorithms. Built with Python and TensorFlow, it provides real-time predictions and interactive visualizations for data-driven decision making.",
    ...
    githubUrl: "https://github.com/techflow/ai-analytics",
    features: [
  ...
  },
  {
    ...
    longDescription: "This secure fintech mobile application revolutionizes digital banking with advanced security features and blockchain integration. Built with Flutter and Node.js, it provides a seamless and secure banking experience with biometric authentication and real-time transaction monitoring.",
    ...
    githubUrl: "https://github.com/techflow/fintech-app",
    features: [
  ...
  },
  {
    ...
    longDescription: "This advanced IoT monitoring system revolutionizes industrial equipment management with real-time monitoring, predictive maintenance, and intelligent alerts. Built with React and Node.js, it provides comprehensive insights into equipment performance and health.",
    ...
    githubUrl: "https://github.com/techflow/iot-monitoring",
    features: [
